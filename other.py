...
# Path a /saved_g mappához, mindig az other.py helyéhez képest
SAVE_DIR = os.path.join(os.path.dirname(__file__), "saved_g")

# Ha nincs, létrehozzuk
os.makedirs(SAVE_DIR, exist_ok=True)

def Save_game(Username,Money,Honor,Integrity,MAX_Integrity,survived_days,Number_OF_MALWARES,NUMBER_OF_BBRUTEF,NUMBER_OF_viruses,NUMBER_OF_DDoS,Number_OF_Decoders,ranges_of_computers,Downloaded_Files,Hostile_EASY_additional_integrity,Hostile_MEDIUM_additional_integrity,Hostile_HARD_additional_integrity, Savings):
...
def Load_game(Username):
    ...
    with open(file_path, "r") as file:
        ...
        for line in lines[16:]:
            ...
            if len(parts) >= 5:
                ...
                f = type('File', (object,), {})()  # Create a simple object to hold file attributes
                f.name = name
                f.kind = kind
    ...
    return (Username, Money, Honor, Integrity, MAX_Integrity, survived_days, Number_OF_MALWARES, NUMBER_OF_BBRUTEF, NUMBER_OF_viruses, NUMBER_OF_DDoS, Number_OF_Decoders, ranges_of_computers, Downloaded_Files, Hostile_EASY_additional_integrity, Hostile_MEDIUM_additional_integrity, Hostile_HARD_additional_integrity, Savings)
